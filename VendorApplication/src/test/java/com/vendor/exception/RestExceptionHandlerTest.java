...
public class RestExceptionHandlerTest
{
	...
	{
		assertEquals(restExceptionHandler.handleProductItemNotFoundException(new ProductItemNotFoundException(null)).getStatusCodeValue(), 400);
	}
	@Test
	public void handleVendorNotFoundExceptions()
	{
		assertEquals(restExceptionHandler.handleVendorNotFoundException(new VendorNotFoundException(null)).getStatusCodeValue(),400);
	}
	@Test
	...
	{
		assertEquals(restExceptionHandler.handleConnectExceptions(new ConnectException(null)).getStatusCodeValue(),400);
	}
	@Test
